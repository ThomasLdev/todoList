...
/* user/new.html.twig */
class __TwigTemplate_e8df864f4e873321134f5f820bee7ec9898fd77a5cf75e6c74003346801fc26f extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <a class=\"btn btn-warning\" href=\"{{ path('user_list') }}\">back to list</a>
{% endblock %}
