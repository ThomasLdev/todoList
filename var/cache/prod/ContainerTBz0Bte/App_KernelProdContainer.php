...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xVyrNuv-Tk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\\Security\\TaskVoter'] ?? ($this->privates['App\\Security\\TaskVoter'] = new \App\Security\TaskVoter()));
            yield 4 => ($this->privates['App\\Security\\UserVoter'] ?? ($this->privates['App\\Security\\UserVoter'] = new \App\Security\UserVoter()));
