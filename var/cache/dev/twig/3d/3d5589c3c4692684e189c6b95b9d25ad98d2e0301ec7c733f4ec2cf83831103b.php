...
class __TwigTemplate_0b6d40b817dfec2ab9397ce9502ff49a52bf8f7943133c6a5753dd95c5833db9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p class=\"h5\">
        ...
        ";
        // line 11
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 11, $this->source); })()), "message", [], "any", false, false, false, 11), "html", null, true);
        echo "
    </p>
    <p>
...
";
    ...
    {
        return array (  103 => 14,  97 => 11,  91 => 7,  81 => 6,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "@Twig/Exception/error403.html.twig", "/var/www/html/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
