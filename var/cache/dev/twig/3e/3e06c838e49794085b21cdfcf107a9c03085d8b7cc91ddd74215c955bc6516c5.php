...
class __TwigTemplate_4707b4163edca2061f614a280965859c1948b3ead457c6ff0588ac0099c90856 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 1, $this->source); })()), 'form_start', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("task_create")]);
        echo "
<div class=\"row\">
    <div class=\"col-12\">
        ";
...
";
    ...
    {
        return array (  65 => 14,  58 => 10,  49 => 4,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{{ form_start(form, {'action' : path('task_create')}) }}
<div class=\"row\">
    <div class=\"col-12\">
        {{ form_widget(form) }}
    </div>
...
<div class=\"row\">
    <div class=\"col-12\">
        <button type=\"submit\" class=\"btn btn-success\">Valider</button>
        <a class=\"btn btn-warning\" href=\"{{ path('task_list') }}\">Retour</a>
    </div>
</div>

{{ form_end(form) }}
", "task/_form.html.twig", "/var/www/html/templates/task/_form.html.twig");
    }
}
